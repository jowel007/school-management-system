...
Route::group(['middleware' => 'parent'], function (){
    ...
    Route::get('parents/my_student', [ParentController::class,'ParentMyStudent']);

    Route::get('parents/my_student/subject/{student_id}', [SubjectController::class,'ParentStudentSubejct']);
});
