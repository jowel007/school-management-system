  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Ebenezer - SMS</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @if (Auth::user()->user_type == 1)
              ...
              <li class="nav-item">
                <a href="{{ url('admin/teacher/list') }}" class="nav-link @if (Request::segment(2) == 'techer') active @endif">
                    <i class="nav-icon far fa-user"></i>
                    <p>
                        Techer
                    </p>
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{ url('admin/assign_class_teacher/list') }}" class="nav-link @if (Request::segment(2) == 'assign_teacher') active @endif">
                      <i class="nav-icon far fa-user"></i>
                      <p>
            ...
            @elseif (Auth::user()->user_type == 2)
              ...
              <li class="nav-item">
                <a href="{{ url('techer/dashboard') }}" class="nav-link  @if(Request::segment(2) == 'dashboard') active @endif">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Dashboard
                  </p>
            ...
            @elseif (Auth::user()->user_type == 4)
                ...
                <li class="nav-item">
                  <a href="{{ url('parents/my_student') }}" class="nav-link  @if(Request::segment(2) == 'my_student') active @endif">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                      My Student
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ url('parents/account') }}" class="nav-link  @if(Request::segment(2) == 'account') active @endif">
                    <i class="nav-icon fas fa-tachometer-alt"></i>
                    <p>
                      My Account
                    </p>
