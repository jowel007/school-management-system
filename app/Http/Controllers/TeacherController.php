...
class TeacherController extends Controller
{
    ...
    public function insert(Request $request){
       ...
       // dd($request->all());
        ...
        return redirect('admin/teacher/list')->with('success','Teacher created Successfully Done');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/teacher/list')->with('info','Teacher Updated Successfully Done');
    ...
    public function delete($id){
        ...
        $getRecord = User::getSingle($id);
            if (!empty($getRecord)){
                ...
                return redirect()->back()->with('warning','Teacher Deleted Successfully Done');
            }
            else
            {
                abort(404);
